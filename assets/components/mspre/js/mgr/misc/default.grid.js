mspre.grid.Default = function (config) {
    config = config || {};
        ...
        viewConfig: {
            ...
            getRowClass: function (rec) {
                ...
                if (rec.data['required'] != undefined && rec.data['required'] == 1) {
                    cls.push('mspre-row-required');
                }
                return cls.join(' ');
            }
        },
    });
    mspre.grid.Default.superclass.constructor.call(this, config);
...
Ext.extend(mspre.grid.Default, MODx.grid.Grid, {
...
Ext.reg('mspre-grid-default', mspre.grid.Default);
